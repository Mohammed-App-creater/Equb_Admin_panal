  ...
  if (!data)
    return (
      <EmptyState
        ...
        description="We couldn't find any report data for this Equb."
      />
    );
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Comprehensive overview of contributions and health.
          </p>
        </div>
        <button
          onClick={exportCSV}
        ...
        <div className="bg-card rounded-3xl p-8 border border-border shadow-soft">
          ...
          <div className="space-y-6">
            <div className="flex justify-between items-end">
              <div>
                ...
                <p className="text-2xl font-black">
                  {collectionRate.toFixed(1)}% REACHED
                </p>
              </div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed italic">
              * Based on data from {data.membersPaid} members who successfully
              cleared their contributions for this cycle.
            </p>
          </div>
        </div>
